...
ChatConfigController.prototype.setOption = function(){
	var Room = require('./ChatRoomController').ChatRoomController;
...
module.exports = {"ChatConfigController": new ChatConfigController()}